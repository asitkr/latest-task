...
//     return (
//         <div className="fixed pt-3 max-w-[60px] w-full flex flex-col bg-[#020234] min-h-screen gap-10">
...
//                 >
//                     {item?.icon}
//                     <span className="absolute font-semibold left-12 top-1/2 -translate-y-1/2 bg-white text-blue-800 text-lg px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-all whitespace-nowrap shadow-md z-50">
//                         {item?.label}
//                     </span>
//                 </div>
//             )
